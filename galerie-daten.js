...
const GALERIE_BILDER = [
  ...
  { id: 'teichleben8', kategorie: 'Teichleben', bild: 'bilder/teichleben/puffin.jpg', alt: 'Papageientaucher auf Felsvorsprung', beschriftung: '<b>Papageientaucher</b> · Brutkolonie Schottland', bestand: 31, bereitsPostkarte: true, bestandPoster: 8, bereitsPoster: true, bereitsLesezeichen: false, bestandLesezeichen: 0, imShop: true, geschichte: null, ort: { lat: 58.640829, lng: -3.026797, label: 'Schottische Küste', bereich: true, radius: 2500 } },
